...
describe('useInventoryActions', () => {
    ...
    describe('quickAddToInventory', () => {
        ...
        it('returns false when user cancels the dialog', async () => {
            ...
            const dialog = makeQuickAddDialog(null)
    ...
    describe('manageInventory', () => {
        it('ICM-01: calls dialog.openManage with the food id', async () => {
            ...
            await manageInventory({id: 42, name: 'Flour'}, mockDialog as any, t)
        ...
        it('ICM-01: returns true when dialog reports hasEntries=true', async () => {
            ...
            const mockDialog = {openManage: vi.fn().mockResolvedValue({hasEntries: true})}
            const {manageInventory} = useInventoryActions()
            const result = await manageInventory({id: 42, name: 'Flour'}, mockDialog as any, t)
