    ...
    <v-layout style="height: 70vh">
        ...
        <v-navigation-drawer style="height: calc(100% + 0px)" v-model="drawer">
            <v-list>
                ...
                <v-list-item link :title="$t('Hierarchy')" :active="window === 'hierarchy'" active-class="font-weight-bold" @click="window = 'hierarchy'" prepend-icon="fa-solid fa-sitemap"></v-list-item>
